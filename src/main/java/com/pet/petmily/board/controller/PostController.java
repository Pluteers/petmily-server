...
public class PostController {
    ...
    public Response getPost(@PathVariable("id") Long id,@PathVariable("channelId") Long channelId) {
        log.info("게시판 개별 조회");
        return new Response("조회 성공","채널별 개별 게시물 return",postService.getPost(id,channelId));
    }
